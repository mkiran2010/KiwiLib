...
void runScreen() {
    while(true) {
        ...
        pros::screen::print(pros::E_TEXT_MEDIUM, 4, "front left dist: %.3f", distFrontLeft.get_distance()/25.4);
        pros::screen::print(pros::E_TEXT_MEDIUM, 5, "front right dist: %.3f", distFrontRight.get_distance()/25.4);
        pros::screen::print(pros::E_TEXT_MEDIUM, 6, "back dist: %.3f", distBack.get_distance()/25.4);
        pros::screen::print(pros::E_TEXT_MEDIUM, 7, "left dist: %.3f", distLeft.get_distance()/25.4);
        pros::screen::print(pros::E_TEXT_MEDIUM, 8, "right dist: %.3f", distRight.get_distance()/25.4);
